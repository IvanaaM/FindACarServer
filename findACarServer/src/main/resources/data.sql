...
insert into car_service (id, about, email, name, phone, address_id, landline_phone) values (1, "About", "rcarNS@gmail.com", "Rent a Car NS", "+38121447389", 1, "+38121447389");
insert into car_service (id, about, email, name, phone, address_id, landline_phone) values (2, "About", "nsrentingcar@gmail.com", "NS Renting Cars", "+38121831664", 2, "+38121447389");
insert into car_service (id, about, email, name, phone, address_id, landline_phone) values (3, "About", "eurorentns@gmail.com", "Euro Rent NS", "+38121233814", 3, "+38121447389");
insert into car_service (id, about, email, name, phone, address_id, landline_phone) values (4, "About", "bgcarrent@gmail.com", "BG Car rent", "+38111744658", 4, "+38121447389");
insert into car_service (id, about, email, name, phone, address_id, landline_phone) values (5, "About", "rentacarBG@gmail.com", "Rent a Car BG", "+38111648331", 5, "+38121447389");
