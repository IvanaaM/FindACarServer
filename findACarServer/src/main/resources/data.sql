...
insert into vehicle values (2, 1, 0, 2, 0, "Description", 5, "Petrol", "Unlimited", "Ford fiesta", 2015, "12/02/2021", 5, "Medium", 2);

insert into vehicle values (3, 1, 0, 5, 0, "Description", 5, "Diesel", "Unlimited", "Nissan Qashqai", 2017, "04/11/2020", 5, "Large", 3);


insert into pricelist values (4, 2500, 2020);
insert into pricelist values (5, 1900, 2020);
insert into pricelist values (6, 1700, 2020);
insert into vehicle values (4, 1, 0, 2, 0, "Description", 5, "Petrol", "Unlimited", "Renault Megan", 2013, "18/10/2020", 5, "Economy", 4);

insert into vehicle values (5, 1, 0, 5, 0, "Description", 5, "Diesel", "Unlimited", "Citroen C3", 2015, "10/05/2021", 5, "Medium", 5);

insert into vehicle values (6, 1, 0, 5, 0, "Description", 5, "Petrol", "Unlimited", "Renault Twingo", 2016, "12/06/2021", 4, "Medium", 6);
