...
insert into car_service (id, about, email, name, phone, address_id, landline_phone) values (2, "NS Renting Cars agency based in Novi Sad has an excellent ratio of price and quality of vehicles. We guarantee: professionalism, reliability, safety", 2, "nsrentingcar@gmail.com", "NS Renting Cars", "+38121831664", "011/3298-448");
...
insert into vehicle values (3, 1, 0, 1, 5, 0, "Description", 5, "Diesel","nissan1.jpg",  "Unlimited", "Nissan Qashqai", 2017, "04/11/2020", 5, "Large", 3);


insert into pricelist values (4, 2500, 2020);
insert into pricelist values (5, 1900, 2020);
insert into pricelist values (6, 1700, 2020);
insert into vehicle values (4, 1, 0, 1, 2, 0, "Description", 5, "Petrol", "renault_megan.jpg", "Unlimited", "Renault Megan", 2013, "18/10/2020", 5, "Economy", 4);
...
insert into reservation values (1, "2020-06-11", 14000.0, "2020-06-18",null, 1);
insert into user_reservations values (2,1);

insert into reservation values (2, "2020-04-15", 19200.0, "2020-04-21", 3, 3);
insert into user_reservations values (2,2);

insert into reservation values (3, "2020-05-23", 22400.0, "2020-05-30",null, 3);
